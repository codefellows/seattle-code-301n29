...
We will spend some time reviewing the concepts from the pre-work. We will also discuss several new topics: `create-react-app` and component-based architecture.
